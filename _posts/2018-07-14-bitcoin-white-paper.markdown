...
![bitcoin-white-paper](/images/bitcoin-white-paper-1.png){:width="284px"}
...
![bitcoin-white-paper](/images/bitcoin-white-paper-2.png){:width="284px"}
...
![bitcoin-white-paper](/images/bitcoin-white-paper-3.png){:width="284px"}
...
![bitcoin-white-paper](/images/bitcoin-white-paper-4.png){:width="284px"}
...
![bitcoin-white-paper](/images/bitcoin-white-paper-5.png){:width="284px"}
...
![bitcoin-white-paper](/images/bitcoin-white-paper-6.png){:width="284px"}
...
![bitcoin-white-paper](/images/bitcoin-white-paper-7.png){:width="284px"}
...
![bitcoin-white-paper](/images/bitcoin-white-paper-8.png){:width="284px"}
...
![bitcoin-white-paper](/images/bitcoin-white-paper-9.png)

当此情形，为了计算攻击者追赶上的概率，我们将攻击者取得进展区块数量的泊松分布的概率密度，乘以在该数量下攻击者依然能够追赶上的概率。


![bitcoin-white-paper](/images/bitcoin-white-paper-10.png)

化为如下形式，避免对无限数列求和：


![bitcoin-white-paper](/images/bitcoin-white-paper-11.png)
...
## 注释    (↵ returns to text)
1. W Dai（戴伟）,a scheme for a group of untraceable digital pseudonyms to pay each other with money and to enforce contracts amongst themselves without outside help（一种能够借助电子假名在群体内部相互支付并迫使个体遵守规则且不需要外界协助的电子现金机制）, “B-money” [http://www.weidai.com/bmoney.txt](http://www.weidai.com/bmoney.txt), 1998↵
...
6. A. Back, “Hashcash – a denial of service counter-measure,”（哈希现金——拒绝服务式攻击的克制方法）[http://www.hashcash.org/papers/hashcash.pdf](http://www.hashcash.org/papers/hashcash.pdf), 2002.↵
